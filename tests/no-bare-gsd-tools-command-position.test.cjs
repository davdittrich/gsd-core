...
const PROSE_ALLOWLIST = [
  { file: 'agents/gsd-executor.md', line: 772, reason: 'describes the SDK return envelope of `gsd-tools query commit`; not an instruction to run the bare word' },
  ...
  { file: 'gsd-core/workflows/execute-plan.md', line: 410, reason: 'describes the downstream SDK validation step (`validated downstream by ...`); names the mechanism, does not instruct the agent to type it' },
];
